import React, { ForwardedRef, SVGProps } from 'react';
  ...
  const CloseCircleFill20 = React.forwardRef(({color = 'currentColor', size= 20, ...otherProps}: {
    color?: string;
    size?: number | string;
  ...
  CloseCircleFill20.displayName = 'CloseCircleFill20';

  export default CloseCircleFill20
