import React, { ForwardedRef, SVGProps } from 'react';
  ...
  const CheckboxUncheckedLine16 = React.forwardRef(({color = 'currentColor', size= 16, ...otherProps}: {
    color?: string;
    size?: number | string;
  ...
  CheckboxUncheckedLine16.displayName = 'CheckboxUncheckedLine16';

  export default CheckboxUncheckedLine16
