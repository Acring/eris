...
export const comboboxVariant = cva(
  [
...
export const commandItemVariant = cva(['cursor-pointer', 'flex flex-col items-start gap-[4px]'], {
  variants: {
    disabled: {
      true: 'cursor-default text-muted-foreground',
      false: '',
    },
    selected: {
      true: 'bg-fill-3 aria-selected:bg-fill-3',
      false: '',
    },
    size: {
      sm: cn('px-1 py-[4px]'),
