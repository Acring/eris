...
export const Selection: Story = {
  render: (props) => {
    function SelectStory(props: any) {
      ...
      return (
        <div className="flex flex-col gap-2">
          ...
          <Alert
            content={defaultShow ? '选择框始终显示' : '选择框默认隐藏，鼠标悬停或选中时显示'}
          />
          <DataTable
            fields={fields}
            data={Basic.data}
    ...
    return <SelectStory {...props}></SelectStory>;
  },
};
...
export const ControlledFocusRow: Story = {
  render: (props) => {
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-1">
            ...
            <Button
              ...
              onClick={() => {
                setFocusRow(
                  focusRow >= Basic.data.length - 1 ? Basic.data.length - 1 : focusRow + 1,
                );
              }}
            >
              next
    ...
    return <ControlledFocusRowStory {...props}></ControlledFocusRowStory>;
  },
};
...
export const Sorting: Story = {
  render: (props) => {
    ...
    return <SortingStory {...props}></SortingStory>;
  },
};
...
export const Filter: Story = {
  render: (props) => {
    ...
    return <FilterStory {...props}></FilterStory>;
  },
};
        ...
        <div>
          <DataTable
            ...
            data={Array.from({ length: 100 }).map((_, idx) => ({
              ...
              age: idx,
              country:
                'this is looooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong' +
                idx,
              country0:
                'this is looooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong' +
                idx,
...
export const ColumnResizing: Story = {
  render: (props) => {
    ...
    return <ColumnResizingStory {...props}></ColumnResizingStory>;
  },
};
...
export const WithContextMenu: Story = {
  render: (props) => {
    ...
    return <WithContextMenuComponent {...props} />;
  },
};
...
export const EmptyState: Story = {
  render: () => {
    function EmptyStateStory() {
      const [emptyType, setEmptyType] = React.useState<
        'default' | 'description' | 'custom' | 'hidden'
      >('default');
